...
-- setup meshmanager
	...
	-- Setup the marker types we wanna use		
		...
		grindMarker:AddField("string", GetUSString("contentIDEquals"),GetUSString("contentIDEquals"), "")
		grindMarker:AddField("string", GetUSString("NOTcontentIDEquals"),GetUSString("NOTcontentIDEquals"), "")
