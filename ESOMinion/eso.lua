	...
	if (esominion.GUI.settings.open) then
		...
		if ( esominion.GUI.settings.visible ) then
			...
			if (tabindex == 1) then
				...
				GUI:AlignFirstTextHeightToWidgets() 
				GUI_Capture(GUI:Checkbox(GetString("Blessed Shards"),gAssistBlessedShards),"gAssistBlessedShards")
				GUI:AlignFirstTextHeightToWidgets() 
				GUI_Capture(GUI:Checkbox(GetString("SKM Weaving"),gSKMWeaving),"gSKMWeaving")
